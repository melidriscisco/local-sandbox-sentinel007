...
class InputSchema(BaseModel):
    ...
    session_id: Optional[str] = Field(None, title="session_id")
    agent_id: Optional[str] = Field(None, title="agent_id")
...
class OutputSchema(BaseModel):
    messages: Optional[List[Message]] = Field(None, title="Messages")
    ia_is_completed: Optional[bool] = Field(None, title="Is Completed")
    final_intent: Optional[str] = Field(
        default=None, description="Final intent produced by the intent_analyzer."
    )
